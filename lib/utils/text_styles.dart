...
class ProjectTextStyle {
  //--------------------------------------WHITE
  static final TextStyle whiteSmall =
      TextStyle(color: ProjectColors.projectWhite, fontSize: 16);

  static final TextStyle whiteSmallStrong = TextStyle(
      color: ProjectColors.projectWhite,
      fontSize: 16,
      fontWeight: FontWeight.bold);

  static final TextStyle whiteMedium =
      TextStyle(color: ProjectColors.projectWhite, fontSize: 20);

  static final TextStyle whiteMediumStrong = TextStyle(
      color: ProjectColors.projectWhite,
      fontSize: 20,
      fontWeight: FontWeight.bold);

  static final TextStyle whiteBig =
      TextStyle(color: ProjectColors.projectWhite, fontSize: 24);

  static final TextStyle whiteBigStrong = TextStyle(
      color: ProjectColors.projectWhite,
      fontSize: 24,
      fontWeight: FontWeight.bold);
//--------------------------------------BROWN
  ...
  //----------------------------------------RED
  static final TextStyle redSmall =
      TextStyle(color: ProjectColors.projectRed, fontSize: 16);

  static final TextStyle redSmallStrong = TextStyle(
      color: ProjectColors.projectRed,
      fontSize: 16,
      fontWeight: FontWeight.bold);

  static final TextStyle redMedium =
      TextStyle(color: ProjectColors.projectRed, fontSize: 20);

  static final TextStyle redMediumStrong = TextStyle(
      color: ProjectColors.projectRed,
      fontSize: 20,
      fontWeight: FontWeight.bold);

  static final TextStyle redBig =
      TextStyle(color: ProjectColors.projectRed, fontSize: 24);

  static final TextStyle redBigStrong = TextStyle(
      color: ProjectColors.projectRed,
      fontSize: 24,
      fontWeight: FontWeight.bold);
}
